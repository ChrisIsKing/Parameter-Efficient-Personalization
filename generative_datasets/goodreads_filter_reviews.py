...
reviews = pd.read_csv('data/goodreads/goodreads_reviews_spoiler_raw.csv')
...
books = pd.read_csv('data/goodreads/goodreads_books.csv')
...
reviews.to_csv('data/goodreads/goodreads_reviews_filtered.csv')