...
data, headers = load_csv('data/subjectivediscourse/with_features_annotated_questions_responses_gold.tsv', delimiter="\t", header=True)
...
# Save the data
with open('data/subjectivediscourse/user_data_leaked.json', 'w') as f:
    json.dump(user_data_leaked, f)

with open('data/subjectivediscourse/user_data_no_leak.json', 'w') as f:
