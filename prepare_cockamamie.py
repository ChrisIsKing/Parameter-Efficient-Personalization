...
data = json.load(open('data/cockamamie/cockamamie.json'))
...
# Save the data
with open('data/cockamamie/user_data_leaked.json', 'w') as f:
    json.dump(user_data_leaked, f)

with open('data/cockamamie/user_data_no_leak.json', 'w') as f:
